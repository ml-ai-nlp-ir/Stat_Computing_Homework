...
The coefficient for genderM, which is 4.5, seems to have the highest effect on los.
...
summary(mod)$coef
```
The intercept is 3.5, and the coefficient for gender is 4.3.
...
summary(mod)
```
Using equal variance produces the same p-value we saw using summary(mod).
